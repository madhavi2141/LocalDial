  ...
  return (
    <header
      className={`p-4 sticky top-0 z-50 transition-all duration-300 ${
        isScrolled ? "bg-[#001f3f]/80 shadow-lg" : "bg-[#001f3f]"
      }`}
    >
      ...
      {/* Mobile Navigation */}
      <ul
        className={`md:hidden fixed top-[70px] w-full bg-[#001f3f] text-white flex flex-col items-start gap-5 px-5 py-10 transform duration-300 ${
